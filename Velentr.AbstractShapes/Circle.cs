...
namespace Velentr.AbstractShapes
{
    ...
    public struct Circle
    {
        ...
        ///     (Immutable) the one.
        /// </summary>
        public static readonly Circle One = new Circle(1, 1, 1);

        /// <summary>
        ///     (Immutable) the maximum value.
        /// </summary>
        public static readonly Circle MaxValue = new Circle(int.MaxValue, int.MaxValue, int.MaxValue);

        /// <summary>
        ///     (Immutable) the minimum value.
        /// </summary>
        public static readonly Circle MinValue = new Circle(int.MinValue, int.MinValue, int.MinValue);
