...
namespace Velentr.AbstractShapes
{
    ...
    public struct Dimensions
    {
        ...
        ///     (Immutable) the zero.
        /// </summary>
        public static readonly Dimensions Zero = new Dimensions(0, 0);

        /// <summary>
        ///     (Immutable) the one.
        /// </summary>
        public static readonly Dimensions One = new Dimensions(1, 1);

        /// <summary>
        ///     (Immutable) the maximum value.
        /// </summary>
        public static readonly Dimensions MaxValue = new Dimensions(int.MaxValue, int.MaxValue);

        /// <summary>
        ///     (Immutable) the minimum value.
        /// </summary>
        public static readonly Dimensions MinValue = new Dimensions(int.MinValue, int.MinValue);
