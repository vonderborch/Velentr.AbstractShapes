...
namespace Velentr.AbstractShapes
{
    ...
    public struct Point
    {
        ...
        /// </summary>
        public static readonly Point MaxValue = new Point(double.MaxValue, double.MaxValue);

        /// <summary>
        ///     (Immutable) the minimum point.
        /// </summary>
        public static readonly Point MinValue = new Point(double.MinValue, double.MinValue);
