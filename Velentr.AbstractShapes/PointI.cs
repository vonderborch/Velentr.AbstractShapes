...
namespace Velentr.AbstractShapes
{
    ...
    public struct PointI
    {
        ...
        /// </summary>
        public static readonly PointI MaxValue = new PointI(double.MaxValue, double.MaxValue);

        /// <summary>
        ///     (Immutable) the minimum point.
        /// </summary>
        public static readonly PointI MinValue = new PointI(double.MinValue, double.MinValue);
