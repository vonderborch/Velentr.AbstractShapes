...
namespace Velentr.AbstractShapes
{
    ...
    public struct Rectangle
    {
        ...
        /// </summary>
        public static readonly Rectangle MaxValue = new Rectangle(int.MaxValue, int.MaxValue, int.MaxValue, int.MaxValue);

        /// <summary>
        ///     (Immutable) the minimum value.
        /// </summary>
        public static readonly Rectangle MinValue = new Rectangle(int.MinValue, int.MinValue, int.MinValue, int.MinValue);
