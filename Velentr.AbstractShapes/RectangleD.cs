...
namespace Velentr.AbstractShapes
{
    ...
    public struct RectangleD
    {
        ...
        ///     (Immutable) the one.
        /// </summary>
        public static readonly RectangleD One = new RectangleD(1, 1, 1, 1);

        /// <summary>
        ///     (Immutable) the maximum value.
        /// </summary>
        public static readonly RectangleD MaxValue = new RectangleD(int.MaxValue, int.MaxValue, int.MaxValue, int.MaxValue);

        /// <summary>
        ///     (Immutable) the minimum value.
        /// </summary>
        public static readonly RectangleD MinValue = new RectangleD(int.MinValue, int.MinValue, int.MinValue, int.MinValue);
